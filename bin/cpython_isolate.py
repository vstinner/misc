"""
Tool to isolate failing tests of the CPython test suite.

Modify Application constructor to set self.failing
"""
...
BLACKLIST = {'test_distutils', 'test_logging'}
...
class Application:
    def __init__(self):
        self.failing = "test_os"
        self.ntest = 20   # number of tests run before failing
        self.parallel = os.cpu_count() + 1  # number of processes running in parallel

        self.uid = 0   # unique identifier
        self.loop = None
        self.pending = None
